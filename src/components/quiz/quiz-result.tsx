...
export default function QuizResult({ title, attemptResult, passingScore, onResetQuiz }: QuizResultProps) {
    return (
        <div className="w-full max-w-2xl mx-auto p-6 bg-card border border-border rounded-2xl shadow-sm text-center space-y-6 text-custom-text-primary">
            ...
            <div className="grid grid-cols-2 gap-4 p-4 bg-muted/50 rounded-xl border border-border/40 text-sm font-medium">
                ...
                <div className="flex flex-col items-center justify-center p-2 border-l border-border/40">
